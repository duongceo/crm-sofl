...
<!--					--><?php //print_arr($row) ?>
                    ...
                    <form method="post" action="<?php echo base_url() . $this->controller_path . '/action_edit_item/' . $row['id']; ?>" class="form_submit">
                                        ...
                                        if (!isset($value['type'])) {
                                            ...
                                            switch ($value['type']) {
												...
												case 'active' :
													...
													$this->load->view('base/edit_item/content/active', $data);
                        ...
                        <div class="text-center">
                            ...
                            <?php if(!isset($landingpage_hide)){ ?>
                            <button type="submit" class="btn btn-success btn-lg btn-edit-contact-1 show_popup">Lưu Lại</button>
                            <?php } ?>
