                                                            ...
                                                            <ul style="list-style:none;padding:0px">
                                                                ...
                                                                <ul>
                                                                    ...
                                                                    <li style="margin-bottom:10px;color:#272727; padding-left: 40px;" > 
                                                                        ...
                                                                        <span style="font-weight:bold"> Tài khoản: </span> <?php echo $phone; ?> </li>

                                                                    <li style="margin-bottom:20px;color:#272727; padding-left: 40px;" >

																	<span style="font-weight:bold"> Mật khẩu: </span><?php echo ($password == 'new') ? 'lakita279' : '(mật khẩu giống như mật khẩu khi quý khách đăng ký tài khoản Lakita)'; ?> </li>
                                                                ...
                                                                <li style="margin-bottom:10px;color:#272727"> https://www.youtube.com/watch?v=9XZe6Xoe0a8 </li>
