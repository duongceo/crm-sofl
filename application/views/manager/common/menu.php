<ul class="nav-list list-inline display-flex">
    ...
    </li>	 <li>        <a data-filter=".97" href="<?php echo base_url().'/quan-ly/contact-moi-trung.html'; ?>">            <img src="<?php echo base_url(); ?>public/images/new.png">             <span> Danh sách contact mới bị trùng (<?php echo $this->L['L1_trung'];?>)            </span>        </a>    </li>
    <li>
...
<ul class="nav-list list-inline display-flex">
    ...
    </li>    <li>        <a href="<?php echo base_url('quan-ly/them-contact.html'); ?>">            <img src="<?php echo base_url(); ?>public/images/add-contact.png">             <span> Thêm mới contact </span>        </a>    </li>
    <li>
