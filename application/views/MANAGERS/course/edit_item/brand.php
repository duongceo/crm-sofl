<tr>
    ...
    <td>
        ...
        <select class="form-control select_course_code selectpicker" name="edit_brand_id">
            ...
            <?php foreach ($arr as $key => $value) {
                ...
                <option value="<?php echo $value['id'] ?>" <?php if ($value['id'] == $row['brand_id']) echo "selected"; ?>> <?php echo $value['name'] ?>
