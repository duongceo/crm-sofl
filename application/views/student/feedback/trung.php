...
<html lang="vi" xmlns="http://www.w3.org/1999/xhtml" prefix="og: http://ogp.me/ns#">
    <head>
        <title>Mẫu dánh giá Trung</title>
                ...
                <div class="">
                    <div class="row can-deu">
                        <div class="col-md-20 form ">
                            <div class="pd-tb-20">
                                <span class="span-1">Thông tin học viên</span>
                            </div>
                            <div class="col-md-24">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input id="keyword1" type="text" value="<?php echo $course ?>" placeholder="Khóa học" name="cate" class="form-control"/>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group">
                    ...
                    <div class="col-md-24">
                        <div class="khoi-bo row text-justify">
                            ...
                            <div class="row mr-t-10">
                                <div class="col-md-12">SOFL Giao tiếp dễ dàng - Vững vàng HSK</div>
