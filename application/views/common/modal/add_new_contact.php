                                ...
                                <div class="form-group">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-8">
                                            ...
                                            <input type="text" class="form-control" placeholder="Họ tên" name="name" value="<?php echo set_value('name') ?>"/>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-8">
                                            ...
                                            <select class="form-control" name="class_study_id">

                                                <option value="empty"> Chọn lớp học </option>

                                                <?php foreach ($class_study as $key => $value) { ?>

                                                    <option value="<?php echo $value['class_study_id']; ?>"

                                                            <?php if (set_value('class_study_id') == $value['class_study_id']) echo "selected"; ?>>
