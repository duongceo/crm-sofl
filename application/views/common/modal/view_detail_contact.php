            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="tab_container">
						...
						<input id="tab3-view" type="radio" name="tabs">

						<label for="tab3-view"><i class="fa fa-history" aria-hidden="true"></i><span>Nhật ký đóng tiền</span></label>
						...
						<section id="content3-view" class="tab-content">
