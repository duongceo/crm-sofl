<tr class="filter_date_rgt_from">
    ...
    <td>
        <input type="text" class="form-control datepicker" name="filter_date_happen_from" autocomplete="off"
...
<tr class="filter_date_rgt_end">
    ...
    <td>
        <input type="text" class="form-control datepicker" name="filter_date_happen_end" autocomplete="off"
