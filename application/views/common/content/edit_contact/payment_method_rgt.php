<tr>
    ...
    <td>  
        <select class="form-control selectpicker edit_payment_method_rgt" type="payment_method_rgt" name="payment_method_rgt">
            <?php foreach ($payment_method_rgt as $key => $value) { ?>
