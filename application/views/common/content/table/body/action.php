...
<?php } ?><?php if ($controller == 'affiliate') { ?>    <td class="center action">		<a href="#" class="btn btn-success ajax-request-modal load-new-contact-id edit-one-contact one-item-selected" data-contact-id="<?php echo $value['id'] ?>" data-modal-name="edit-contact-div" data-url="common/show_edit_contact_modal">		<i class="fa fa-pencil-square" aria-hidden="true"></i>  Chăm sóc 		</a>		<a href="#" class="btn btn-info ajax-request-modal load-new-contact-id one-item-selected" data-contact-id="<?php echo $value['id'] ?>" data-modal-name="view-detail-contact-div" data-url="common/view_detail_contact">  		<i class="fa fa-info-circle" aria-hidden="true">		</i> Chi tiết </a>    </td><?php } ?>
