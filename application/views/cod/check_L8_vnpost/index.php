...
<form action="#" method="GET" class="form-inline" id="form_item">
    ...
    <?php $this->load->view('base/filter_item/index'); ?>
     ...
     <div class="number_paging" > 
        ...
        Tổng tiền VNPOST thu của khách: <?php echo isset($rows) ? number_format(h_sum_money_1($rows), 0, ",", ".") . " VNĐ" : 0; ?>

    </div>

    <div class="number_paging" > 

        Tổng tiền giao cho VNPOST: <?php echo isset($rows) ? number_format(h_sum_money($rows), 0, ",", ".") . " VNĐ" : 0; ?>
