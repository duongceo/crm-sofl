...
<form action="<?php echo base_url(); ?>CODS/check_L8_vnpost/confirm_check_l8" method="POST" id="action_contact" class="form-inline"> 
    ...
    <div class="number_paging" > 
        ...
        Tổng tiền VNPOST thu của khách: <?php echo isset($contacts) ? number_format(h_sum_money_1($contacts), 0, ",", ".") . " VNĐ" : 0; ?>

    </div>

    <div class="number_paging" > 

        Tổng tiền giao cho VNPOST: <?php echo isset($contacts) ? number_format(h_sum_money($contacts), 0, ",", ".") . " VNĐ" : 0; ?>
