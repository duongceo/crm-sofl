...
function find_source_sale_id($staff_id,$chanel_id){
    ...
    if(!empty($staff) && !empty($channel)){
        ...
        if(($staff[0]['source_sale_id'] == 2 && $chanel[0]['source_sale_id'] == 1) || ($staff[0]['source_sale_id'] == 1 && $chanel[0]['source_sale_id'] == 2)){
