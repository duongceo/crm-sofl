...
define('_KHONG_LIEN_LAC_DUOC_', 5);
...
define('_CONTACT_TU_VAN_TRUNG_CHET_', 7);
define('_CONTACT_DANG_KY_TRUNG_CHET', 8);
...
define('ACCESS_TOKEN', 'EAAXk6rdtETQBAEsSygwc35MDsBP81PflC7wPImDzwR9OrF4ymlbkCnKnUcZAHh8bWK3NRTrqdZAU4eo15iAxZCvGJK1xVDaZChhYVoD8ZADXCXWeok3XZCszebMyEcCEKjjCZBwpjJT8Xq1nvlEUFzZAVU9zaUNrgAmtKZBZCFNHhMnQZDZD');

preg_match('/(?<=access_token=)[^&]*(?=&)/', 
        'https://graph.facebook.com/v2.10/142153949788733/insights?access_token=EAAXk6rdtETQBAEsSygwc35MDsBP81PflC7wPImDzwR9OrF4ymlbkCnKnUcZAHh8bWK3NRTrqdZAU4eo15iAxZCvGJK1xVDaZChhYVoD8ZADXCXWeok3XZCszebMyEcCEKjjCZBwpjJT8Xq1nvlEUFzZAVU9zaUNrgAmtKZBZCFNHhMnQZDZD&__business_id=503487699812479&_reqName=object%3AreportRun%2Finsights&_reqSrc=AdsInsightsTableAlphaDataFetchingPolicy.fetchFooter%3EfetchAsync%3EgetReportRunInsights&include_headers=false&limit=5000&locale=vi_VN&method=get&pretty=0&suppress_http_code=1'
        , 
        $matches);
...
define('MARKETING_KPI_PER_DAY', 150);
define('TVTS_KPI_PER_DAY', 101);

define('_VER_CACHED_', '24.1.09.2020');
