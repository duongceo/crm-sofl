...
$route['quan-ly/contact-moi-trung.html'] = 'manager/new_duplicate';
...
$route['quan-ly/contact-cho-chuyen.html'] =  'manager/transfer_contact_sale';
...
//$route['cod/contact-da-nhan-hang.html'] = 'cod/receive';
//$route['cod/contact-da-cham-soc-hom-nay.html'] = 'cod/care_today';
//$route['cod/contact-can-cham-soc.html'] = 'cod/call_back';
...
//
//$route['cod/tai-file-doi-soat-l8-vnpost.html'] = 'CODS/check_L8_vnpost/upload_file';
//$route['cod/doi-soat-l8-vnpost.html'] = 'CODS/check_L8_vnpost';
//$route['cod/doi-soat-l8/xem-tat-ca-vnpost.html'] = 'CODS/check_L8_vnpost/view_all';
//$route['cod/doi-soat-l8/ket-qua-doi-soat-vnpost-hom-nay.html'] = 'CODS/check_L8_vnpost/today';
//
...
//$route['cod/xem-tat-ca-contact.html'] = 'cod/view_all_contact';
//
//$route['dai-ly/san-pham.html'] = 'affiliate/product';

$route['default_controller'] = 'home';
$route['404_override'] = '';
$route['translate_uri_dashes'] = FALSE;

$route['manager/contact-file-excel.html'] = 'MANAGERS/contact_excel';
$route['manager/them-contact-file-excel.html'] = 'MANAGERS/contact_excel/upload_file';

$route['cam-on-da-dang-ky.html'] = 'contact/add_contact';
