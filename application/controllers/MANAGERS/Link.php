...
class Link extends MY_Table {
    ...
    function index($offset = 0) {
		...
		$this->data['channel'] = $this->get_data_from_model('channel');
...
//        $data['top_nav'] = 'manager/common/top-nav';
        ...
        $data['list_title'] = 'Link';

        $data['edit_title'] = 'Link';
        ...
        $this->list_add = array(
            ...
            'right_table' => array(
                ...
                'landingpage_id' => array(
                    ...
                    'value' => $this->get_data_from_model('landingpage')
    ...
    function action_add_item() {
        ...
        if (!empty($post)) {
            ...
            if (!empty($exist_link)) {
                ...
                show_error_and_redirect('Link vừa tạo : ' . $url);
    ...
    function get_ad() {
        ...
        $post = $this->input->post();
		//echo '<pre>'; print_r($post['adset_id']);die;
