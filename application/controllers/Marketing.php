...
//				Chi phí tại HCM
			...
			$Report[$key]['L5/C3'] = ($Report[$key]['C3'] == 0) ? '0' : str_replace(',', '.', number_format(round($Report[$key]['L5'] / $Report[$key]['C3'])));
		...
		$Report['Tổng'] = array(
			'C3' => $total_C3,
			'L5' => $total_L5,
			'L5/C3' => ($total_C3 == 0) ? '0' : str_replace(',', '.', number_format(round($total_L5 / $total_C3, 2) * 100)),
...
//				 echo '<pre>'; print_r($spend); die;
			...
			$Report_mkt[$key]['L5/C3'] = ($Report_mkt[$key]['C3'] == 0) ? '0' : str_replace(',', '.', number_format(round($Report_mkt[$key]['L5'] / $Report_mkt[$key]['C3'])));
		...
		$Report_mkt['Tổng'] = array(
			'C3' => $total_mkt_C3,
			'L5' => $total_mkt_L5,
			'L5/C3' => ($total_mkt_C3 == 0) ? '0' : str_replace(',', '.', number_format(round($total_mkt_L5/ $total_mkt_C3, 2) * 100)),
